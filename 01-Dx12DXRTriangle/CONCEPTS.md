...
- [Acceleration Structures](#acceleration-structures)
  ...
  - [Building the Acceleration Structures](#building-the-acceleration-structures)
    - [(1) `CreateBottomLevelAS(vVertexBuffers)`:](#1-createbottomlevelasvvertexbuffers)
    - [(2) `CreateTopLevelAS(instances)`:](#2-createtoplevelasinstances)
    - [(3) `CreateAccelerationStructures()`:](#3-createaccelerationstructures)
...
- [Resources](#resources)
    - [`CreateRaytracingOutputBuffer()`:](#createraytracingoutputbuffer)
    - [`CreateShaderResourceHeap()`:](#createshaderresourceheap)
