...
D3D12Lighting::D3D12Lighting(const UINT width, const UINT height,
...
void D3D12Lighting::OnUpdate()
{
	//Not used in this tutorial
}

void D3D12Lighting::OnRender()
{
...
uint32_t D3D12Lighting::BeginFrame() const
{
...
void D3D12Lighting::EndFrame(const uint32_t rtvIndex)
{
	DirectXUtil::D3D12GraphicsContext::resourceBarrier(
		mpCmdList,
		mFrameObjects[rtvIndex].pSwapChainBuffer,
...
SampleFramework::ID3D12RootSignaturePtr D3D12Lighting::createRootSignature(
...
void D3D12Lighting::createAccelerationStructures()
{
...
void D3D12Lighting::createRtPipelineState()
{
	// Need 12 subobjects:
...
void D3D12Lighting::createShaderTable()
{
...
void D3D12Lighting::createShaderResources()
{
