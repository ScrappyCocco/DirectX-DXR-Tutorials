![Screenshot of Dx12 DXR primitive rendering](ReadmeMedia/screenshot.png)

# Primitives Rendering
This example shows how to create a Raytracing Acceleration Structure from vertex and index geometry buffers.
